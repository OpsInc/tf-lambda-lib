...
| <a name="input_dynamodb_kms_key_arn"></a> [dynamodb\_kms\_key\_arn](#input\_dynamodb\_kms\_key\_arn) | DynamoDB KMS key arn | `string` | `""` | no |
| <a name="input_lambdas"></a> [lambdas](#input\_lambdas) | Map of all lambda projects with config | `any` | `{}` | no |
...
| [aws_iam_role_policy_attachment.AmazonLambdaInvoke](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
